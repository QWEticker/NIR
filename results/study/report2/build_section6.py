"""Сборка SECTION6.docx из SECTION6.md с встраиванием рисунков и таблиц.

Резолвер изображений ищет в report2/, report2/figures/ и results/study/figures/.
"""
import os
import re
...
MD = os.path.join(HERE, "SECTION6.md")
OUT = os.path.join(HERE, "SECTION6.docx")
STUDY_FIGS = os.path.normpath(os.path.join(HERE, "..", "figures"))
...
def resolve_img(path):
    for base in (HERE, os.path.join(HERE, "figures"), STUDY_FIGS):
